...
function dePalabrasAFrase(palabras) {
  ...
  const lista2 = lista.substring(0, lista.length - 1)
  return lista2;
}
...
function mesesDelAño(array) {
  ...
  verificar = ["Enero", "Marzo" , "Noviembre"]
  lista = []
  
  for (var i = 0; i < array.length; i++){
    if (array[i] === verificar[0] || array[i] === verificar[1] || array[i] === verificar[2]){
      lista.push(array[i]);
    }
  }
